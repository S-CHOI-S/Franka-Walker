...
def main():
    ...
    ppo = PPO(N_S, N_A, log_dir, num_avg_constraints=2, avg_cstrnt_limit=average_constraint_limit)
    ...
    for iter in tqdm(range(Iter)):
        ...
        while steps < 2048: #Horizon
            ...
            for _ in range(MAX_STEP):
                ...
                # cost4 = -next_state[6]
                prob1 = -state[3]
                prob1_next = -next_state[3]

                mask = (1-done)*1
                memory.append([state, action, reward, next_state, mask, [cost1, cost2]])
...
if __name__ == "__main__":
    ...
    log_dir = f"../runs/walker/{current_time}/"
