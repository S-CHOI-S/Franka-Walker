...
#                         color='r', alpha=0.1)
#
#         ax.plot(data1['Iteration'], np.full(len(data1['Iteration']), 1), label=label1, color='b', linestyle='--')
#         ax.plot(data1['Iteration'], data1[constraint_limit_type_mean], label="Adaptive Constraint Threshold", color='g', linestyle='--')
#         ax.plot(data1['Iteration'], data1[constraint_type_mean], label=label2, color='r')
#
...
#
# # 2 constraints
# file_dir1 = "/home/kist/franka_walker/runs/20240805_11-01-04/"
#
# # 4 constraints
# file_dir1 = "/home/kist/franka_walker/runs/20240805_11-01-04/"
#
...
def preprocess_df(data, smoothing=100000000000, end=None):
...
def draw_plot(data1, constraint, label1="Desired Limit", label2="Constraint", figure_number=None, save_fig_path=None):
    ...
    if constraint == "prob_constraint1":
        ...
        ax.plot(x_data, np.full(len(data1['prob_constraint1']), 0.2), label="", color='r', linestyle='--')
...
# 2 constraints
file_dir1 = "/home/kist/franka_walker/runs/20240805_18-43-51/"

file_path1 = file_dir1 + "prob_constraint.npy"
data1 = preprocess_df(load_npy(file_path1))
file_path2 = file_dir1 + "prob_constraint_next.npy"
